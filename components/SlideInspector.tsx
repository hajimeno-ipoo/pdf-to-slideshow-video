        ...
        <div className="flex justify-end" />
	      ...
	      <div className="flex-1 flex flex-col landscape:flex-row lg:!flex-col overflow-hidden">
			          ...
			          {(() => {
			              ...
			              <div
                        ref={previewAreaRef}
                        className={`relative bg-transparent flex items-center justify-center overflow-hidden select-none group/canvas ${
                            previewDetachedOpen
                                ? 'w-full h-full p-6'
                  ...
                  <div style={{
                      ...
                      height: previewDetachedOpen && detachedImageBox ? '100%' : undefined,
		                      ...
		                      <img 
		                        ...
		                        alt="Slide" 
		                        className={`${previewDetachedOpen ? 'w-full h-full' : 'max-h-[260px] w-auto'} max-w-full object-contain pointer-events-none block`} 
		                        draggable={false} 
		                        style={{
