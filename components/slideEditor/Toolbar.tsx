             ...
             {isAddSlideOpen && (
                 <div className="p-3 flex flex-wrap items-center gap-3 animate-fade-in-down">
                     ...
                     <div className="flex gap-2 w-full sm:w-auto">
                         ...
                         <button onClick={() => imageAddInputRef.current?.click()} className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 text-xs bg-blue-600 hover:bg-blue-500 px-3 py-1.5 rounded text-white transition-colors border border-blue-500 shadow-sm whitespace-nowrap font-medium">
                     ...
                     <div className="relative flex items-center gap-2 bg-slate-800 px-2 py-1.5 rounded border border-slate-700">
                       <button 
                          ref={colorBtnRef}
                          onClick={() => setShowColorPicker(!showColorPicker)}
                          className="w-10 h-10 rounded-md border border-slate-600 shadow-inner"
