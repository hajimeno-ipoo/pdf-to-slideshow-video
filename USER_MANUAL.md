...
### まず大事：編集はだいたい“すぐ反映”されるよ
- いまは、インスペクターでいじった内容が **すぐ反映** される作りだよ（Appleっぽい感じ）
- Undo（元に戻す）も、増えすぎないように **まとめて1回ぶん** になりやすいよ

### 「適用」ボタンってなに？
- 右上の **「適用」** は、主に **スライド一覧のサムネ（小さい見本画像）を作り直すボタン** だよ
- 「一覧の絵がまだ古いかも？」ってときに押すと安心だよ（更新中はボタンが止まるよ）
...
- 右の「スライド編集」で **「適用」** を押してみてね（サムネを作り直すよ）
